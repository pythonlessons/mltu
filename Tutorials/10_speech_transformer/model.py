...
class Encoder(tf.keras.layers.Layer):
    ...
    """
    def __init__(self, num_layers: int, d_model: int, num_heads: int, dff: int, dropout_rate: float=0.1):
        """
        ...
        self.pos_embedding = PositionalEmbedding(vocab_size=0, d_model=d_model, embedding=self.speech_embedding)
...
def SpeechTransformer(
    ...
    encoder = Encoder(num_layers=num_layers_encoder, d_model=d_model, num_heads=num_heads, dff=dff, dropout_rate=dropout_rate)(encoder_input)
    decoder = Decoder(num_layers=num_layers_decoder, d_model=d_model, num_heads=num_heads, dff=dff, vocab_size=target_vocab_size, dropout_rate=dropout_rate)(decoder_input, encoder)
